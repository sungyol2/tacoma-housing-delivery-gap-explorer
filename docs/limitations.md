...
- This is an independent portfolio case study, not an official Tacoma or Pierce County product.
- The before/after comparison is descriptive and does not isolate zoning effects from market conditions, financing, owner decisions, project lead time, or other concurrent changes.
- Current UR zoning geography is applied retrospectively because historical parcel-level zoning geometry is unavailable.
...
- Critical-area GIS is generalized screening evidence and can omit unmapped resources, site-specific buffers, geotechnical conditions, or permitted modifications.
- Public parcel-level utility-easement geometry was unavailable; easements require title and utility review.
- The City Year One benchmark and independent ETL use different source and classification practices. The independent result is not presented as a replication.
