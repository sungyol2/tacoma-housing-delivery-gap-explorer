...
## 1. Proposed units increased much faster than applications or estimated projects

Within today's three Urban Residential districts, the pre-policy annual average was 177.0 non-cancelled applications, 170.2 estimated projects, and 226.8 proposed units. Home in Tacoma Year One contains 231 applications, 193 estimated projects, and 416 units.
...
Detached-house applications declined from 69.6 annually to 54. Backyard/accessory dwelling unit applications increased from 88.2 to 116. Duplex applications increased from 2.2 to 26, with estimated projects increasing from 2.0 to 19 and proposed units from 4.4 to 63.
...
UR-1 shows the largest increase in application volume, while UR-2 and UR-3 show much larger increases in proposed units than in estimated projects. Today's zoning is applied retrospectively, so this is descriptive geography rather than a historical-zone causal comparison.
...
The February 2020–2026 layer combines Residential and Commercial workflows and alterations that explicitly create or legalize dwelling units. It removes repairs and nonhousing scopes, deduplicates permit numbers, classifies housing type, and groups applications into estimated projects.

The public parcel map and the headline policy comparison use related but different sets of records. The map excludes clear non-housing uses; the headline comparison uses non-cancelled applications across today's three Urban Residential districts. Map totals therefore need not equal the headline.
